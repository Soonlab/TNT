...
- **Figure 3.** Pre-CRT Thread 1 — tumor-intrinsic DNA-repair / cell-cycle axis (§3.3). **A** Hallmark running-ES for top sets; **B** Hallmark NES × FDR bubble; **C** Reactome pathway dotplot; **D** GSEA enrichment-map network; **E** ssGSEA 95-set heatmap; **F** category-level NES boxplot.
...
- **Figure 5.** Integrated nested-LOOCV LASSO predictor on the parsimonious 36-feature panel (§3.5). **A** Feature correlation; **B nested outer-LOOCV ROC: drop-CD8-proliferation ElasticNet AUC 0.745 (95 % bootstrap CI 0.56–0.90)**; **C** four-feature coefficient forest (DSB repair +0.89, genomic deletion fraction −0.76, MHC II −0.23, MSI % +0.12); **D** UMAP of integrated features; **E** SHAP beeswarm on the 4-feature model; **F** per-subject predicted probability.
