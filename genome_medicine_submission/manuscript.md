...
- **Figure 7.** External validation — meta-analysis across seven public GEO nCRT cohorts (forest plot, signature heatmap, Stouffer Z-scores, cohort concordance, funnel plot) showing partial reproducibility consistent with radiation-phase-TNT-specific biology.
- **Supp 1–11.** Cohort QC, SBS signatures (incl. SBS landscape composite), CNV/HRD, oncoprint/VAF, full GSEA, ssGSEA/CMS, TRUST4 immune repertoire, ML model comparison, GEO cohort details, HLA/neoantigen detail, PyClone-VI diagnostics.
